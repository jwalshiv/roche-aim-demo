...
const MESSAGE_LIBRARY = {
  ...
  "CRR-06e": { type: "lead", text: "Promoter accounts renew 90% more often than Detractors", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  "CRR-06f": { type: "lead", text: "Promoter accounts have a 53% higher win rate than Detractors", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  "CRR-06g": { type: "lead", text: "Promoter accounts generate ~58% of the revenue", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  ...
  "CRR-07d": { type: "lead", text: "88% Overall satisfaction with Roche", source: "Slide 7", buyingInfluence: ["clinical","operational","financial"], customerChallenge: ["product-technical"] },
  "CRR-07e": { type: "lead", text: "89% Believe Roche is a true partner", source: "Slide 7", buyingInfluence: ["clinical","operational","financial"], customerChallenge: ["strategic-partnership"] },
