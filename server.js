...
const MESSAGE_LIBRARY = {
  ...
  "CRR-06e": { type: "proof", relatedLead: ["CRR-06a"], text: "Promoter accounts renew 90% more often than Detractors", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  "CRR-06f": { type: "proof", relatedLead: ["CRR-06a"], text: "Promoter accounts have a 53% higher win rate than Detractors", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  "CRR-06g": { type: "proof", relatedLead: ["CRR-06a"], text: "Promoter accounts generate ~58% of the revenue", source: "Slide 6", buyingInfluence: ["financial"], customerChallenge: ["operational-excellence-uptime"] },
  ...
  "CRR-07d": { type: "proof", relatedLead: ["CRR-07a"], text: "88% Overall satisfaction with Roche", source: "Slide 7", buyingInfluence: ["clinical","operational","financial"], customerChallenge: ["product-technical"] },
  "CRR-07e": { type: "proof", relatedLead: ["CRR-07a","CRR-17a"], text: "89% Believe Roche is a true partner", source: "Slide 7", buyingInfluence: ["clinical","operational","financial"], customerChallenge: ["strategic-partnership"] },
  ...
  "CRR-09b": { type: "proof", relatedLead: ["CRR-09a"], text: "60% of our customers would recommend Roche; only 8% would not", source: "Slide 9", buyingInfluence: ["clinical","financial"], customerChallenge: ["product-technical"] },
  ...
  "CRR-34a": { type: "proof", relatedLead: ["CRR-07a","CRR-17a"], text: "Foundation of trust: Customers rate Roche highly for reliable products and professional staff. With an NPS of +49 and 89% seeing us as a true partner, trust in our people and solutions is our biggest strength", source: "Slide 34", buyingInfluence: ["clinical","financial"], customerChallenge: ["strategic-partnership","product-technical"] },
  ...
  "CRR-29c": { type: "proof", relatedLead: ["CRR-07a","CRR-34d"], text: "Enhancing the TOP account experience through CRR helps better secure China's business", source: "Slide 29, quote \u2014 Carolin Wang, Service Strategy & Transformation, China" },
